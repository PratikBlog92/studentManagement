...
<jsp:include page="/Admin/reuse/header.jsp"></jsp:include>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Installment 3</h1>
                </div>
            </div>
				...
				<lable>Installment 3 :</lable><br>
					<input type="text" name="install3" class="form-control" placeholder="Enter Installment" required>
				...
				<lable>Next Installment Date :</lable><br>	
					<input type="date" name="date3" class="form-control" placeholder="Enter Installment 2" required>
...
<%
		if(request.getParameter("install2") != null)
		{
			...
			String nextDate = request.getParameter("date3");
			...
			Boolean b =  s.regStudWithThirdInstallment(sp);
