	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Installment 5 List</h1>
					</div>
				</div>
				...
				<%
					try {
						...
						PreparedStatement ps = co.prepareStatement("SELECT * FROM `studentinfo` WHERE `installment1` != 0 AND `installment2` !=0 AND `balence` != 'NIL' AND `installment3` !=0 AND `installment4` !=0 AND `installment5` =0");
