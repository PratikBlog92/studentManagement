        ...
        <div class="container-fluid">
            ...
            <div class="row">
				...
				<lable>Installment 4 :</lable><br>
					<input type="text" name="install4" class="form-control" placeholder="Enter Installment" required>
				...
				<lable>Next Installment Date :</lable><br>	
					<input type="date" name="nextInstallDate" class="form-control" placeholder="Enter Next Installment" required>
...
<%
		if(request.getParameter("install2") != null)
		{
			...
			String nextDate = request.getParameter("nextInstallDate");
			...
			Boolean b =  s.regStudWithForthInstallment(sp);
